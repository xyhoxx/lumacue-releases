...
## 0.8.6 - Hotfix: การเลือกเพลงจากแชต Twitch

### แก้ไข
- ปรับขั้นตอนเลือกเพลงชื่อซ้ำให้ผู้ชมเลือกศิลปินที่แสดงอยู่, พิมพ์ศิลปินอื่น, ส่งคำค้นใหม่ หรือตอบด้วยลิงก์เพลงที่รองรับได้โดยไม่เอาคำตอบไปต่อท้ายชื่อเพลงเดิมผิด ๆ
- ให้ LumaCue รับคำตอบอิสระเฉพาะข้อความที่ Reply กลับมายังคำถามเลือกเพลง หรือข้อความที่ขึ้นต้นด้วย `!pick` และไม่เอาแชตทั่วไปของผู้ชมไปค้นหาเพลงอีก
- ผูกคำตอบกับคำถามเลือกเพลงล่าสุด ป้องกันคำตอบหรือผลส่งข้อความที่มาช้าจากคำถามเก่าไปเลือกเพลงผิด
- ปฏิเสธลิงก์ YouTube/Spotify playlist จากการแลกแต้มและคำตอบเลือกเพลง พร้อมแจ้งให้ผู้ชมส่งลิงก์เพลงเดี่ยวแทน
- ยังคงรับลิงก์เพลง YouTube แบบ `watch?v=...&list=...` โดยตัดข้อมูล playlist ออกและเปิดเพลงที่ระบุด้วย `v=` ตามเดิม
